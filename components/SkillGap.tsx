            ...
            {result && (
                ...
                <div className="bg-green-50 dark:bg-green-900/10 p-8 rounded-3xl border border-green-100 dark:border-green-900/30">
                    ...
                    {(result.masteredSkills || []).map((skill, i) => (
                        <div key={i} className="flex items-center px-4 py-2 bg-white dark:bg-green-900/20 rounded-xl text-green-700 dark:text-green-300 font-medium border border-green-100 dark:border-green-800 shadow-sm">
                            {skill}
                        </div>
                    ))}
                    </div>
